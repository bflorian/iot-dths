...
metadata {
    definition (name: "RGBW Child Device", namespace: "InovelliUSA", author: "Eric Maycock", ocfDeviceType: "oic.d.light", mnmn: "SmartThings", vid: "generic-rgbw-color-bulb") {
        capability "Switch"
...
def setColorTemperature(temp) {
    parent.componentSetColorTemperature(device.deviceNetworkId, temp)
}
