...
metadata {
    definition (name: "Inovelli Dimmer Red Series LZW31-SN (NEW)", namespace: "InovelliUSA", author: "Eric Maycock", 
...
def initialize() {
    ...
    sendEvent(name: "supportedButtonValues", value:
        ['pushed', 'held', 'up', 'up_2x', 'up_3x', 'up_4x', 'up_5x', 'down', 'down_2x', 'down_3x', 'down_4x', 'down_5x'].encodeAsJson())
