...
metadata {
    ...
    definition (name: "Inovelli Dimmer Red Series LZW31-SN", namespace: "InovelliUSA", author: "Eric Maycock", mnmn: "SmartThingsCommunity", vid: "855ad491-1148-37dd-9107-bef3e1d55d35") {
        capability "Switch"
        capability "Refresh"
        capability "Polling"
        capability "Actuator"
