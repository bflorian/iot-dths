 ...
 */
metadata {
	definition(name: "Z-Wave Switch Generic (local)", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.switch") {
		capability "Actuator"
...
def refresh() {
	...
	def result = delayBetween(commands)
    log.trace "refresh(): ${result}"
	result
}